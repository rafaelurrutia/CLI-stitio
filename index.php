...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        print("<div class='panel panel-default'>
          ...
          foreach ($dirArray as $key => $elemento) {
             ...
             if(($elemento!='.') && ($elemento!='..') && ($elemento!='elementos.php') && ($elemento!='footer.php') && ($elemento!='loader.php') && ($elemento!='listadeiconos.php') && (preg_match("/transicion*/i", $elemento) != 1) && (preg_match("/header*/i", $elemento) != 1) && in_array($ext,$arr_exts))  // Se filtran los elementos del arreglo que quieren mostrarse
             {
