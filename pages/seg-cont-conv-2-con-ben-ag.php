<?php include('header.php'); ?>
    ...
    <div class="seg-cont-conv-2 seg-conv seg-conv-s-cot-seguro-2 seg-cont-conv-2-con-ben-ag">
        <?php
        $class1='visited';
        $class2='active';
        $class3='';
        ...
        <div class="container scc-2">
            ...
            <div class="row container_resena_datos container-general">         
                ...
                <div class="row_resena_datos">
                    <div class="row seg-resena-datos">
                        <div class="container-fluid"><p class="p-destacado-1">Beneficiario</p></div> 
                        <div class="col-md-8">
                            <i class="icon-ico-paciente"></i>
                            <h5></h5>
                            <p><strong>Nicolás Arévalo Varela</strong></p>
            ...
            <div class="bgc7">
                ...
                <button class="btn boton-flota-rc boton-tipo-2-agregar"><span></span>Agregar beneficiario</button>
            </div>
            <div class="col-sm-12">
